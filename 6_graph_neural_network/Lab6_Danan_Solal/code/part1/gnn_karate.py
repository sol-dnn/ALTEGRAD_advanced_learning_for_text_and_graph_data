...
G = nx.read_weighted_edgelist('/Users/dnn/M2DS 24-25/Courses/ALTEGRAD/Cour6_DL_graph/ALTEGRAD_lab_6_DLForGraphs_2024/code/data/karate.edgelist', delimiter=' ', nodetype=int, create_using=nx.Graph())
...
class_labels = np.loadtxt('/Users/dnn/M2DS 24-25/Courses/ALTEGRAD/Cour6_DL_graph/ALTEGRAD_lab_6_DLForGraphs_2024/code/data/karate_labels.txt', delimiter=',', dtype=np.int32)
...
############## Task 3
adj = nx.adjacency_matrix(G)  # Scipy sparse adjacency matrix
features = np.random.randn(n, n_hidden)  # Shape: [n_nodes, n_hidden]
...
############## Task 4
alpha = alpha.detach().cpu().numpy()  # Convert attention scores to NumPy array
